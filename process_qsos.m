...
sample_log_posteriors_dla_sub = nan(num_quasars, num_dla_samples);
sample_log_posteriors_dla_sup = nan(num_quasars, num_dla_samples);
...
variables_to_save = {'training_release', 'training_set_name', ...
    ...
    'sample_log_posteriors_dla_sub', 'probabilities_dla_sup', ...
